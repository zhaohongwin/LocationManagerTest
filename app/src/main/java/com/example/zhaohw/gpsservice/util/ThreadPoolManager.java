package com.example.zhaohw.gpsservice.util;
...
public class ThreadPoolManager {
	...
	private ThreadPoolExecutor getThreadService() {
		if (!isThreadServiceEnable()) {
			threadService = new ThreadPoolExecutor(10, 10, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>());
		}
	...
	public ScheduledFuture<?> addTimerTask(TimerTask timerTask, long initialDelay, long period, TimeUnit unit) {
